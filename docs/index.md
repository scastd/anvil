...
=== "Gradle"
    ...
    ```groovy
    implementation 'io.github.scastd:anvil-core:0.1.2'
    ```
...
=== "Gradle"
    ...
    ```groovy
    implementation 'io.github.scastd:anvil-processor-gson:0.1.2'
    ```
...
=== "Gradle"
    ...
    ```groovy
    implementation 'io.github.scastd:anvil-processor-jackson:0.1.2'
    ```
